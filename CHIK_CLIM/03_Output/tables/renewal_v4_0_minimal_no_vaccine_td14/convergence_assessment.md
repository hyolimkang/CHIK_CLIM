...
- Divergences: 0.
- Maximum R-hat: 1.009.
- Minimum bulk ESS: 480.825.
- BFMI was above the prespecified 0.30 threshold in every chain.

## Why this run is not accepted

- Maximum-treedepth hits: 0 (0.05% of retained transitions).
- Hits by chain: 1, 1, 0, 0.
- Tree-depth quantiles: median 10, 95th percentile 11, 99th percentile 11.
