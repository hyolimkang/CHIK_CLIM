...
source(here::here(
  "02_Script/90_development_archive/02_historical_renewal_versions/05_v3_0_spatial/prepare_renewal_v3_0_spatial_data.R"
))
...
write_v3_0_implementation_report <- function(prepared, compiled, pilot = NULL, sampling_chains = 1L) {
  ...
  lines <- c(
    ...
    "- 02_Script/90_development_archive/02_historical_renewal_versions/05_v3_0_spatial/prepare_renewal_v3_0_spatial_data.R",
    "- 02_Script/90_development_archive/02_historical_renewal_versions/05_v3_0_spatial/fit_renewal_v3_0_spatial.R",
    "- 02_Script/90_development_archive/02_historical_renewal_versions/05_v3_0_spatial/diagnose_renewal_v3_0_spatial.R",
    "",
