...
run_verify_ablation_identity <- function() {
  root <- verify_root()
  archived_path <- file.path(root, "02_Script", "90_development_archive", "02_historical_renewal_versions", "20_v4_1_q_only", "archive", "renewal_ceara_v4_0_minimal_no_vaccine_ARCHIVED.stan")
