...
# Output location: results/tables/diagnostics/reports were relocated out of
# 40_renewal_model/37_ceara_historical_age12_vaccine_counterfactual/ into the
# project-wide 03_Output/<category>/ceara_historical_age12_vaccine_counterfactual/
...
message(sprintf("[config] Results dir: %s", DIR_RESULTS))
