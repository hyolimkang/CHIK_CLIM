...
source(file.path(climate_root(), "02_Script", "00_shared", "functions", "01_build_ceara_state_weekly.R"))
source(file.path(climate_root(), "02_Script", "07_national_pipeline", "06_national_wave_analysis", "00_national_wave_analysis_helpers.R"))
