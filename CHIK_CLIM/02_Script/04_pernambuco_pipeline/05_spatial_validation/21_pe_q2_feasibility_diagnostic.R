...
figure_dir <- file.path(root, "03_Output/04_pernambuco_pipeline/figures/pernambuco_v4_9_replication/spatial0_q2")
...
feasible <- in_range |> dplyr::filter(q_recife_in_range, q_rest_in_range, u14_close, biologically_plausible)
