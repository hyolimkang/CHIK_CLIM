...
source(file.path(root, "02_Script", "04_pernambuco_pipeline", "05_spatial_validation", "17_build_pe_spatial0_stan_data.R"))
...
run_spatial0_pilot <- function() {
  ...
  stan_path <- file.path(root, "02_Script", "00_shared", "stan", "current", "pernambuco", "renewal_pernambuco_v4_9_spatial0.stan")
