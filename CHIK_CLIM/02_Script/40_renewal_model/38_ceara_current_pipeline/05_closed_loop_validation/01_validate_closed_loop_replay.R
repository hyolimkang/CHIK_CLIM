...
first_divergence <- comparison |> filter(rel_diff_X > DIVERGENCE_THRESHOLD | rel_diff_S > DIVERGENCE_THRESHOLD | rel_diff_U > DIVERGENCE_THRESHOLD) |>
  arrange(t) |> slice(1)
...
write_csv(comparison |> filter(rel_diff_X > DIVERGENCE_THRESHOLD | rel_diff_S > DIVERGENCE_THRESHOLD | rel_diff_U > DIVERGENCE_THRESHOLD),
