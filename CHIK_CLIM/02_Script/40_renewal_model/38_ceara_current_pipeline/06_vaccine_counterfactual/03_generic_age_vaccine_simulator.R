...
# modify 38_ceara_current_pipeline/04_age_reconstruction/02_age_cohort_simulator.R
# (moved from 36_climate_forced_v4_9/scripts/07_age_cohort_simulator.R in the
# pipeline refactor). The
