...
run_analysis <- function(fit_id) {
  root <- v4_4_root()
  base_dir <- file.path(root, "02_Script", "40_renewal_model", "23_v4_4_four_week_observation")
...
run_v4_4_analysis <- function() {
  ...
  weekly_acf <- read_csv(file.path(root, "02_Script/40_renewal_model/22_v4_3_short_2015_2019_q_calibration/weekly_residual_acf.csv"), show_col_types = FALSE)
