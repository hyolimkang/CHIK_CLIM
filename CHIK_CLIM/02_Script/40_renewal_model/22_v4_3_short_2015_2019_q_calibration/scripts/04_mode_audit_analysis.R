...
load_mode_fit <- function(root, tag) {
  path <- file.path(root, "02_Script/40_renewal_model/22_v4_3_short_2015_2019_q_calibration/outputs", tag, paste0("renewal_ceara_v4_3_fit_", tag, ".rds"))
  readRDS(path)
}
...
run_mode_audit_analysis <- function() {
  ...
  full_v4_2_path <- file.path(root, "02_Script/40_renewal_model/21_v4_2_q_juazeiro_serology/outputs/stageB4/renewal_ceara_v4_2_fit_stageB4.rds")
