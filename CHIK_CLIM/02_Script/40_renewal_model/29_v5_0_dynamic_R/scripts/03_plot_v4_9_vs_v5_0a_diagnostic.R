...
b9 <- readRDS(file.path(root, "02_Script/40_renewal_model/28_v4_9_hierarchical_seasonality/outputs/q0.05/renewal_ceara_v4_9_fit_q0.05.rds"))
b50 <- readRDS(file.path(root, "02_Script/40_renewal_model/29_v5_0_dynamic_R/outputs/v5_0a_q0.05/renewal_ceara_v5_0a_fit_q0.05.rds"))
