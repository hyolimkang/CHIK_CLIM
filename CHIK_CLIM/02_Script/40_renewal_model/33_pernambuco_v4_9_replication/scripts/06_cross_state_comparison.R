...
ce <- readRDS(file.path(root, "02_Script/40_renewal_model/28_v4_9_hierarchical_seasonality/outputs/q0.05/renewal_ceara_v4_9_fit_q0.05.rds"))
ba <- readRDS(file.path(root, "02_Script/40_renewal_model/30_bahia_v4_9_replication/outputs_global_q_multisite_serology/on_full2/renewal_bahia_global_q_fit_on_full2.rds"))
pe <- readRDS(file.path(root, "02_Script/40_renewal_model/33_pernambuco_v4_9_replication/outputs/modelB_U14/renewal_pe_global_q_fit_modelB_U14.rds"))
