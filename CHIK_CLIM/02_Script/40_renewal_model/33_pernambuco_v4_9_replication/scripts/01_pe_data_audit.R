...
weekly_cases <- build_state_weekly(panel, "26") |> filter(week_start >= DATE_START, week_start <= DATE_END)
...
pe_major_waves <- wave_census |> filter(state == "PE", major_epidemic_primary == TRUE) |>
