...
weekly_cases <- build_state_weekly(panel, "33") |> filter(week_start >= DATE_START, week_start <= DATE_END)
...
writeLines(md, file.path(dirname(table_dir), "..", "..") |> file.path("02_Script/40_renewal_model/34_rio_de_janeiro_v4_9_replication/RJ_v49_input_audit.md"))
...
rj_major_waves <- wave_census |> filter(state == "RJ", major_epidemic_primary == TRUE) |>
