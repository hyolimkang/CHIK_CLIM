# ===========================================================================
# 09f_fetch_mato_grosso_sinasc_weekly_births.R
#
# Mato Grosso equivalent of 09d_fetch_rio_de_janeiro_sinasc_weekly_births.R,
# for the MT external-replication of the frozen v4.9 renewal model.
...
# changes the CODMUNRES filter to "51" (Mato Grosso). Does NOT modify the
# Ceara/Bahia/Pernambuco/Rio de Janeiro scripts or outputs.
#
# Output
# ------
#   01_Data/mato_grosso_sinasc_births_daily.rds
#   01_Data/mato_grosso_sinasc_births_weekly.rds
# ===========================================================================
...
fetch_uf_births_one_year <- function(year, cache_dir, uf_prefix) {
  ...
  if (n_unparsed > 0) {
    message(sprintf(
      "[warn] %d/%d Mato Grosso SINASC %d records had an unparseable DTNASC and were dropped",
...
if (sys.nframe() == 0) {
  ...
  daily_path <- here::here("01_Data/mato_grosso_sinasc_births_daily.rds")
  weekly_path <- here::here("01_Data/mato_grosso_sinasc_births_weekly.rds")
