# ===========================================================================
# 09d_fetch_rio_de_janeiro_sinasc_weekly_births.R
#
# Rio de Janeiro equivalent of 09c_fetch_pernambuco_sinasc_weekly_births.R,
# for the RJ external-replication of the frozen v4.9 renewal model.
...
# changes the CODMUNRES filter to "33" (Rio de Janeiro). Does NOT modify
# the Ceara/Bahia/Pernambuco scripts or outputs.
#
# Output
# ------
#   01_Data/rio_de_janeiro_sinasc_births_daily.rds
#   01_Data/rio_de_janeiro_sinasc_births_weekly.rds
# ===========================================================================
...
fetch_uf_births_one_year <- function(year, cache_dir, uf_prefix) {
  ...
  if (n_unparsed > 0) {
    message(sprintf(
      "[warn] %d/%d Rio de Janeiro SINASC %d records had an unparseable DTNASC and were dropped",
...
if (sys.nframe() == 0) {
  ...
  daily_path <- here::here("01_Data/rio_de_janeiro_sinasc_births_daily.rds")
  weekly_path <- here::here("01_Data/rio_de_janeiro_sinasc_births_weekly.rds")
